...
import '../../../bloc/trx_bengkel/trx_bengkel_bloc.dart';
...
class _TrxSuccessItemState extends State<TrxSuccessItem> {
  void initState() {
    ...
    super.initState();
    var status = 'success';
    context.read<TrxBengkelBloc>().add(TrxBengkelEvent.getAll(status));
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: BlocBuilder<TrxBengkelBloc, TrxBengkelState>(
